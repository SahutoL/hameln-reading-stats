...
const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
  return (
    <div className="animate-fade-in">
      {/* Hero Section */}
      <section className="text-center py-24 md:py-32 flex items-center justify-center min-h-screen">
      ...
      <section className="py-20 bg-black/20 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4 text-on-surface">
            あなたの読書を、次のレベルへ
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Feature
              icon={<BadgeCheckIcon className="w-12 h-12" />}
              title="実績とレベルシステム"
            >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-center mb-12 text-on-surface">
            簡単3ステップで開始
          </h2>
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 relative max-w-4xl mx-auto">
            ...
            <div
              className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 border-t-2 border-dashed border-gray-700/70"
              style={{ transform: "translateY(-50%)", zIndex: 0 }}
            ></div>

            <div className="relative z-10 flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center text-2xl font-bold text-white mb-4 border-4 border-background">
                1
              </div>
              <h3 className="font-bold text-xl mb-2">ログイン</h3>
              <p className="text-sm text-gray-400">
                お使いのハーメルンアカウントで安全にログインします。
              </p>
            </div>
            <div className="relative z-10 flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center text-2xl font-bold text-white mb-4 border-4 border-background">
              ...
              <p className="text-sm text-gray-400">
                あなたの読書データが自動で取得され、美しいダッシュボードに変換されます。
              </p>
            </div>
            <div className="relative z-10 flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center text-2xl font-bold text-white mb-4 border-4 border-background">
      ...
      <section className="py-20 bg-black/20 backdrop-blur-sm">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold text-center mb-8 text-on-surface">
            よくある質問
          </h2>
          <FAQItem question="本当に無料ですか？">
            はい、すべての機能を完全無料でご利用いただけます。当サービスは、ページ内に表示される広告収益によって運営されています。
          </FAQItem>
