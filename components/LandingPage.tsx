...
import { LogoIcon, ChartBarIcon, BadgeCheckIcon, KeyIcon } from "./icons";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Feature
              ...
              title="実績とレベル"
            >
              読書量に応じてレベルアップし、目標達成で実績を解除。ゲーミフィケーション要素で読書のモチベーションを高めます。
            </Feature>
            <Feature
              icon={<KeyIcon className="w-12 h-12" />}
              title="簡単な連携と安全性"
            >
              ハーメルンのアカウント情報を入力するだけ。パスワードは保存されず、安全に読書データを連携できます。
            </Feature>
          </div>
        </div>
      </section>
